...
namespace llvm::pass::coverage::branch {
    ...
    class BranchCoveragePass : public NamedRegisteredPass<BranchCoveragePass> {
    ...
    public:
        ...
        static constexpr auto name = "Branch Coverage Pass";
    ...
    bool registered = BranchCoveragePass::register_();
