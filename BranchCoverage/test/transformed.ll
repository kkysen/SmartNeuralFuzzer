...
@.str = private unnamed_addr constant [14 x i8] c"onBranch: %s\0A\00", align 1
@.str.1 = private unnamed_addr constant [5 x i8] c"true\00", align 1
@.str.2 = private unnamed_addr constant [6 x i8] c"false\00", align 1
@.str.3 = private unnamed_addr constant [22 x i8] c"onMultiBranch: %d/%d\0A\00", align 1
...
define dso_local void @__BranchCoverage_onBranch(i1 zeroext) #4 {
  %2 = alloca i8, align 1
  %3 = zext i1 %0 to i8
  ...
  %5 = trunc i8 %4 to i1
  %6 = zext i1 %5 to i64
  %7 = select i1 %5, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0)
...
; Function Attrs: noinline optnone uwtable
define dso_local void @__BranchCoverage_onMultiBranch(i32, i32) #4 {
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.3, i32 0, i32 0), i32 %5, i32 %6)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testSwitch(i32) #5 {
...
; <label>:5:                                      ; preds = %1
  call void @__BranchCoverage_onMultiBranch(i32 1, i32 5)
  store i32 1, i32* %2, align 4
  br label %10

; <label>:6:                                      ; preds = %1
  call void @__BranchCoverage_onMultiBranch(i32 2, i32 5)
  store i32 2, i32* %2, align 4
  br label %10

; <label>:7:                                      ; preds = %1
  call void @__BranchCoverage_onMultiBranch(i32 3, i32 5)
  store i32 3, i32* %2, align 4
  br label %10

; <label>:8:                                      ; preds = %1
  call void @__BranchCoverage_onMultiBranch(i32 4, i32 5)
  store i32 100, i32* %2, align 4
  br label %10

; <label>:9:                                      ; preds = %1
  call void @__BranchCoverage_onMultiBranch(i32 0, i32 5)
...
define dso_local i32 @main(i32, i8**) #6 {
  ...
  %6 = load i32, i32* %4, align 4
  %7 = call i32 @testSwitch(i32 %6)
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i32 0, i32 0), i32 %7)
  %9 = load i32, i32* %4, align 4
  %10 = icmp eq i32 %9, 1
  call void @__BranchCoverage_onBranch(i1 %10)
...
; <label>:12:                                     ; preds = %2
  ...
  %14 = icmp eq i32 %13, 2
  call void @__BranchCoverage_onBranch(i1 %14)
...
declare void @__BranchCoverage_onInfiniteBranch(i64)
