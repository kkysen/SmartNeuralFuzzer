...
@.str.3 = private unnamed_addr constant [15 x i8] c"before branch\0A\00", align 1
@.str.4 = private unnamed_addr constant [20 x i8] c"after branch: true\0A\00", align 1
@.str.5 = private unnamed_addr constant [21 x i8] c"after branch: false\0A\00", align 1
...
define dso_local i32 @main(i32, i8**) #5 {
  ...
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0))
...
; <label>:11:                                     ; preds = %2
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.5, i32 0, i32 0))
